...
namespace Engine.GameStateManagerment
{
    /// <summary>
    ...
    public class ScreenManager : DrawableGameComponent
    {
        ...
        static ScreenManager singletonInstance = null;
        ...
        /// <summary>
        /// Singleton access to the screen manager
        /// </summary>
            ...
            : base(game)
        {
            ...
            if (singletonInstance != null)
                throw new InvalidOperationException("Only one screen manager allowed");

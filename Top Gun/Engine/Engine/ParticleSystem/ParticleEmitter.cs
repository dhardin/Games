...
namespace Engine.ParticleEmitter
{
    /// <summary>
    ...
    public class ParticleEmitter
    {
        ...
        /// </summary>
        public ParticleEmitter(Engine.ParticleSystem.ParticleSystem particleSystem, float particlesPerSecond, Vector2 initialPosition)
        {

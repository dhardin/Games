...
namespace Engine.Screens
{
    ...
    public class MenuScreen : GameScreen
    {
        ...
        protected virtual void UpdateMenuEntryLocations()
        {
            ...
            Vector2 position = (menuEntries.Count % 2 == 1) ?  
                new Vector2(0f, (ScreenManager.GraphicsDevice.Viewport.Height / 2) - 
                    (menuEntries[0].GetHeight(this) * (int)(menuEntries.Count / 2) ) - (menuEntries[0].GetHeight(this) / 2)) 
                : 
                new Vector2(0f, (ScreenManager.GraphicsDevice.Viewport.Height / 2) - 
                    (menuEntries[0].GetHeight(this) * (int)(menuEntries.Count / 2)));
